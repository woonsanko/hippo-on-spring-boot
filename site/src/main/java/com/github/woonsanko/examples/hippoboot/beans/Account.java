...
@HippoEssentialsGenerated(internalName = "hippoonspringboot:account")
@Node(jcrType = "hippoonspringboot:account")
public class Account extends HippoCompound {

    public static final String TYPE = "hippoonspringboot:type";
    public static final String LINK = "hippoonspringboot:link";

    @HippoEssentialsGenerated(internalName = "hippoonspringboot:type")

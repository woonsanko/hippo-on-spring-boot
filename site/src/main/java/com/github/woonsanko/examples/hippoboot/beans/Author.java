...
@Node(jcrType = "hippoonspringboot:author")
public class Author extends HippoDocument implements AuthorEntry {

    public static final String ROLE = "hippoonspringboot:role";
    public static final String ACCOUNTS = "hippoonspringboot:accounts";
    public static final String FULL_NAME = "hippoonspringboot:fullname";
    public static final String IMAGE = "hippoonspringboot:image";
    public static final String CONTENT = "hippoonspringboot:content";

    @HippoEssentialsGenerated(internalName = "hippoonspringboot:fullname")
    ...
    @HippoEssentialsGenerated(internalName = "hippoonspringboot:role")
    ...
    public HippoGalleryImage getImage() {
  	...
  	@HippoEssentialsGenerated(internalName = "hippoonspringboot:accounts")

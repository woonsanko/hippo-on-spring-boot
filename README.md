...
So, in this demo project, the **Repository** servlet in [cms/src/main/webapp/WEB-INF/web.xml](cms/src/main/webapp/WEB-INF/web.xml#L159:L164) was replaced by [DeferredInitDelegatingServlet](https://bloomreach-forge.github.io/hipshoot/hipshoot-spring-boot-support/index.html) for *deferred asynchronous initialization*. [Javadoc](https://bloomreach-forge.github.io/hipshoot/apidocs/org/onehippo/forge/hipshoot/spring/boot/support/servlet/DeferredInitDelegatingServlet.html).

This way, you can start up the servlet container fast enough without having to wait for the **RepositoryServlet** to initialize synchronously. This optional feature can be very helpful when deploying onto cloud based platform such as CloudFoundry.

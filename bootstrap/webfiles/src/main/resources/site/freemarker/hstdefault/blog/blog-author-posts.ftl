...
<#-- @ftlvariable name="item" type="com.github.woonsanko.examples.hippoboot.beans.Blogpost" -->
<#-- @ftlvariable name="author" type="com.github.woonsanko.examples.hippoboot.beans.Author" -->
